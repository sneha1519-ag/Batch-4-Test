    ...
    try {
        ...
        const populateSectionFilter = () => {
            ...
            sectionFilter.innerHTML = '<option value="all">All Sections</option>' +
                '<option value="all">DayScholar</option>' +
            '<option value="all">Hostelers</option>';
        ...
        const pieChart = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                const easy = student.easySolved;
                const medium = student.mediumSolved;
                const hard = student.hardSolved;
                const totalSolved = student.totalSolved;

                const barColors = ["red", "green","blue","orange"];
                const xValues = ["Easy", "Medium", "Hard", "Total"];
                const yValues = [easy, medium, hard, totalSolved];
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4 text-pink-400">${student.totalSolved - oldData[student.roll]}
                    &uarr;
                    </td>
                `;
